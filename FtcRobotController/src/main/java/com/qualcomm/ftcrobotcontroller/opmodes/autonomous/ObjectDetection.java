// Temporarily disabled since we removed opencv
...
//
//public class ObjectDetection implements Filter {
//
//    // reference picture
...
//
//    // The corner coordinates of the reference image, inpixels.
...
//
//    // Features of the scene (current frame)
//    private final MatOfKeyPoint mSceneKeypoints = new MatOfKeyPoint();
//
//    // Descroptors of teh scene's features
...
//
//    // The good detected corner coordinates, inpixels, as integers
...
//
//
//    public ObjectDetection(final Context context,
...
//        //TODO: there might be a better equation for converting that has better contrast for our needs
